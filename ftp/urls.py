...
from .views import  Start_Sync,List_One_Drive,Post_Code_OneDrive,Create_Remote_Server_OneDrive,Create_Remote_Server, Create_Sync_Direction, Delete_Server, Get_Code_Access_From_Server,Get_User_Servers, List_Google_Folders, Post_Code

app_name='sync_app'
urlpatterns = [
    path("create_server",Create_Remote_Server.as_view(),name='create_remote_server'),
    ...
    path('get_token/<str:server_name>',Post_Code.as_view(),name='post code'),
    ...
    path("list_one_drive_folders/<str:server_name>/<str:id>",List_One_Drive.as_view(),name='list_folders_onedrive'),
